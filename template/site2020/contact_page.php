...
<figure class="bloc-contact phone">
    ...
    <figcaption class="figcaption-contact">
        <h2>Appelez-moi</h3>
            <p><a href="<?php echo "tel:" . $valreseau[2]["lien"]?>"><?php echo $valreseau[2]["lien"]?></a></p>
            <!--créer dans la bdd, l'enregistrement -->
    </figcaption>
</figure>
<figure class="bloc-contact mail">
    ...
    <figcaption class="figcaption-contact">
        <h2>Ecrivez-moi</h3>
            <p><a href="<?php echo "mailto:" . $valreseau[3]["lien"]?>"><?php echo $valreseau[3]["lien"]?></a></p>
            <!--lister à la suite avec du php -->
    </figcaption>
</figure>
