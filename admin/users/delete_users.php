...
if(!isset($_GET["userdelete"])) { // on verifie que nous avons bien l'identifiant de notre user à supprimer.
    header ("location:list_users.php?userdelete=vide");
} else {
    $leUser = unUser($_GET["userdelete"]);
    // on a l'identifiant embarqué dans $_GET, nous supprimons le user
